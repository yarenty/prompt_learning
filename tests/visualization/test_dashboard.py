...
def dashboard():
    ...
    return DashboardServer(host="localhost", port=8050, update_interval=0.1, history_size=10)
...
def sample_data():
    ...
    return {
        "metrics": {"accuracy": [0.85, 0.87, 0.89], "latency": [0.15, 0.14, 0.13]},
        "resources": {"memory": [512, 524, 538], "cpu": [45, 48, 52]},
        "comparisons": {"accuracy": {"model1": [0.85, 0.87, 0.89], "model2": [0.82, 0.84, 0.86]}},
    }
