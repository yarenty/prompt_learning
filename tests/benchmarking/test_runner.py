...
async def test_evaluate_dataset(benchmark):
    ...
    results = await benchmark._evaluate_dataset(
        "dataset1",
        ["model1", "model2"]
    )
...
async def test_evaluate_model(benchmark):
    ...
    results = await benchmark._evaluate_model(
        "model1",
        "dataset1"
    )
...
def test_aggregate_model_results(benchmark, sample_results):
    ...
    results = benchmark._aggregate_model_results(
        "model1",
...
def test_calculate_effect_sizes(benchmark):
    ...
    effect_sizes = benchmark._calculate_effect_sizes(
        baseline_results,
        model_results
    )
...
def test_calculate_improvements(benchmark):
    ...
    improvements = benchmark._calculate_improvements(
        baseline_results,
        model_results
    )
