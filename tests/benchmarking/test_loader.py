...
def sample_dataset():
    ...
    return Dataset.from_dict({"text": ["Sample text 1", "Sample text 2"], "label": [0, 1]})


@pytest.fixture
def sample_dataset_dict():
    """Create sample dataset dictionary."""
    dataset = Dataset.from_dict({"text": ["Sample text 1", "Sample text 2"], "label": [0, 1]})
...
def test_cache_operations(loader, sample_dataset, sample_dataset_dict):
    ...
    for split in loaded_dataset_dict:
        ...
        assert loaded_dataset_dict[split].column_names == sample_dataset_dict[split].column_names
